...
public:
    ...
    void setUp(Shader& ourShader, string win) {

        setUpWall(ourShader, win);
    }
...
private:
    ...
    void setUpWall(Shader& ourShader, string win) {
        ...
        string photo = "resources/Fotos_midi_maze/winner/" + win + ".jpg";
